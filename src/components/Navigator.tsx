...
const Button = styled.div<{
  ...
  & div * {
    color: var(${(props) => (props.highlighted ? '--black' : '--gray400')});
    stroke: var(${(props) => (props.highlighted ? '--black' : '--gray400')});
  }
`;
