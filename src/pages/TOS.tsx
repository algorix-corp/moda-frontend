...
export default function TOS() {
  ...
  return (
    <Container>
      ...
      <Text>
        TERMS OF SERVICE Last updated November 01, 2023 AGREEMENT TO OUR LEGAL
        TERMS We are Algorix LLC ("Company," "we," "us," "our"), a company
        registered in New York, United States at 447 Broadway, New York, NY
        10013, USA, 2nd Floor 1159, New York, NY 10013. We operate the website
        https://ride.moda (the "Site"), the mobile application MODA (the "App"),
        ...
        You can contact us by phone at (US)(929) 305-0668, email at
        support@algorix.io, or by mail to 447 Broadway, New York, NY 10013, USA,
        2nd Floor 1159, New York, NY 10013, United States. These Legal Terms
        constitute a legally binding agreement made between you, whether
        personally or on behalf of an entity ("you"), and Algorix LLC,
        ...
        permitted to use or register for the Services. We recommend that you
        print a copy of these Legal Terms for your records. TABLE OF CONTENTS 1.
        OUR SERVICES 2. INTELLECTUAL PROPERTY RIGHTS 3. USER REPRESENTATIONS 4.
        USER REGISTRATION 5. PURCHASES AND PAYMENT 6. CANCELLATION 7. PROHIBITED
        ACTIVITIES 8. USER GENERATED CONTRIBUTIONS 9. CONTRIBUTION LICENSE 10.
        MOBILE APPLICATION LICENSE 11. SERVICES MANAGEMENT 12. PRIVACY POLICY
        13. TERM AND TERMINATION 14. MODIFICATIONS AND INTERRUPTIONS 15.
        GOVERNING LAW 16. DISPUTE RESOLUTION 17. CORRECTIONS 18. DISCLAIMER 19.
        LIMITATIONS OF LIABILITY 20. INDEMNIFICATION 21. USER DATA 22.
        ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 23.
        MISCELLANEOUS 24. CONTACT US 1. OUR SERVICES The information provided
        when using the Services is not intended for distribution to or use by
        ...
        local laws are applicable. 2. INTELLECTUAL PROPERTY RIGHTS Our
        ...
        our Legal Terms, please address your request to: support@algorix.io. If
        ...
        REPRESENTATIONS By using the Services, you represent and warrant that:
        ...
        username is inappropriate, obscene, or otherwise objectionable. 5.
        PURCHASES AND PAYMENT We accept the following forms of payment: - Tmoney
        - Cashbee You agree to provide current, complete, and accurate purchase
        ...
        in South Korean Won. You agree to pay all charges at the prices then in
        ...
        distributors. 6. CANCELLATION You can cancel your subscription at any
        ...
        support@algorix.io or call us at (US)(929) 305-0668. 7. PROHIBITED
        ACTIVITIES You may not access or use the Services for any purpose other
        ...
        are specifically endorsed or approved by us. As a user of the Services,
        you agree not to: Systematically retrieve data or other content from the
        ...
        revenue-generating endeavor or commercial enterprise. 8. USER GENERATED
        CONTRIBUTIONS The Services does not offer users to submit or post
        ...
        users of the Services and through third-party websites. When you create
        ...
        things, termination or suspension of your rights to use the Services. 9.
        ...
        feedback regarding the Services, you agree that we can use and share
        ...
        legal action against us regarding your Contributions. 10. MOBILE
        APPLICATION LICENSE Use License If you access the Services via the App,
        ...
        application license contained in these Legal Terms. You shall not: (1)
        ...
        any applications, accessories, or devices for use with the App. Apple
        and Android Devices The following terms apply when you use the App
        ...
        on a device that utilizes the Apple iOS or Android operating systems, as
        ...
        App as specified in the terms and conditions of this mobile application
        ...
        against you as a third-party beneficiary thereof. 11. SERVICES
        MANAGEMENT We reserve the right, but not the obligation, to: (1) monitor
        the Services for violations of these Legal Terms; (2) take appropriate
        ...
        facilitate the proper functioning of the Services. 12. PRIVACY POLICY We
        ...
        hosted in South Korea. If you access the Services from any other region
        ...
        Korea, then through your continued use of the Services, you are
        transferring your data to South Korea, and you expressly consent to have
        your data transferred to and processed in South Korea. 13. TERM AND
        TERMINATION These Legal Terms shall remain in full force and effect
        ...
        criminal, and injunctive redress. 14. MODIFICATIONS AND INTERRUPTIONS We
        ...
        15. GOVERNING LAW These Legal Terms shall be governed by and defined
        following the laws of South Korea. Algorix LLC and yourself irrevocably
        consent that the courts of South Korea shall have exclusive jurisdiction
        to resolve any dispute which may arise in connection with these Legal
        Terms. 16. DISPUTE RESOLUTION Binding Arbitration Any dispute arising
        ...
        shall be Seoul, South Korea. The language of the proceedings shall be
        Korean. The governing law of these Legal Terms shall be substantive law
        of South Korea. Restrictions The Parties agree that any arbitration
        ...
        court. 17. CORRECTIONS There may be information on the Services that
        ...
        prior notice. 18. DISCLAIMER THE SERVICES ARE PROVIDED ON AN AS-IS AND
        ...
        JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE. 19. LIMITATIONS OF
        ...
        TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR SOUTH KOREAN
        WON. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW
        ...
        and hold us harmless, including our subsidiaries, affiliates, and all of
        ...
        or arising out of: (1) use of the Services; (2) breach of these Legal
        Terms; (3) any breach of your representations and warranties set forth
        in these Legal Terms; (4) your violation of the rights of a third party,
        ...
        of it. 21. USER DATA We will maintain certain data that you transmit to
        the Services for the purpose of managing the performance of the
        Services, as well as data relating to your use of the Services. Although
        ...
        undertaken using the Services. You agree that we shall have no liability
        to you for any loss or corruption of any such data, and you hereby waive
        any right of action against us arising from any such loss or corruption
        of such data. 22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND
        SIGNATURES Visiting the Services, sending us emails, and completing
        ...
        electronic means. 23. MISCELLANEOUS These Legal Terms and any policies
        or operating rules posted by us on the Services or in respect to the
        ...
        these Legal Terms. 24. CONTACT US In order to resolve a complaint
        regarding the Services or to receive further information regarding use
        of the Services, please contact us at: Algorix LLC 447 Broadway, New
        York, NY 10013, USA 2nd Floor 1159 New York, NY 10013 United States
        Phone: (US)(929) 305-0668 support@algorix.io
      </Text>
    </Container>
  );
}
